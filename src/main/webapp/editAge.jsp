...
<%
  AgeGroup age = (AgeGroup) request.getAttribute("age");
%>
<html>
<head>
...
<div class="form-container">
  <h2>Edit Age Group</h2>
  <form action="UpdateAgeServlet" method="post">
    <input type="hidden" name="id" value="<%= age.getId() %>" />

    <label>Label (e.g. 1-3 years):</label>
    <input type="text" name="label" value="<%= age.getLabel() %>" required />

    <input type="submit" value="Update Age Group" />
  </form>
